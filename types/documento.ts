...
export interface IDocumento {
  ...
  created_at: string
  updated_at: string
  /** Solo en el listado del estudio: quien lo pide puede eliminarlo (pendiente y
   *  propio; fuera de Cofianza, además, con el estudio en preparación, en
   *  revisión o con información incompleta). Lo calcula el API (P19). */
  eliminable?: boolean
