...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary-600/10 border border-primary-600/20 mb-6">
              ...
              <span className="text-sm text-primary-400 font-medium">Afianzadora digital en Colombia</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-5 leading-tight">
              Arriendas sin codeudor,<br />
              <span className="text-primary-400">100% digital</span>
            </h1>
            <p className="text-lg text-gray-400 max-w-xl mb-8">
              Cofianza es la afianzadora que respalda tu contrato de arrendamiento. Nosotros somos tu fiador — sin buscar codeudor, sin papeleos, todo desde tu celular.
            </p>
          ...
          <div className="grid grid-cols-3 gap-6 mt-16 max-w-lg">
            ...
            <div>
              <p className="text-3xl font-bold text-white">Sin</p>
              <p className="text-xs text-gray-500 mt-1">codeudor</p>
            </div>
            <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-2 text-xs text-gray-400">
            ...
            <span className="flex items-center gap-1.5">
              ...
              Estudio crediticio con TransUnion
            </span>
            <span className="flex items-center gap-1.5">
      ...
      {/* Como funciona — el corazón del negocio, va primero */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center mb-14">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mt-2">
              Arriendas en 3 pasos, sin codeudor
            </h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              Cofianza es la afianzadora que respalda tu contrato. Nosotros asumimos el rol de fiador para que no tengas que pedirle a nadie más.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <StepCard
              number="1"
              icon={
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-primary-600"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
              }
              title="Elige el inmueble"
              description="Te interesa un inmueble publicado en Cofianza o en una inmobiliaria aliada. Le das click en “Me interesa” y agendas la visita."
            />
            <StepCard
              number="2"
              icon={
              ...
              title="Te evaluamos"
              description="Hacemos el estudio crediticio con TransUnion en minutos. Si pasas, nosotros firmamos como tu fiador — no necesitas codeudor."
            />
            <StepCard
              number="3"
              icon={
              ...
              description="Firma electrónica desde tu celular (por WhatsApp o email). Contrato listo en minutos y tú con las llaves en la mano."
            />
          </div>
        </div>
      </section>

      {/* Property Grid — secundario. Vitrina como herramienta complementaria. */}
      <main id="vitrina" className="bg-gray-50 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-8">
            <span className="text-xs font-semibold text-gray-500 tracking-wider uppercase">Vitrina</span>
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mt-2">¿Aún no tienes inmueble?</h2>
            <p className="text-gray-500 mt-2 max-w-2xl mx-auto">
              Explora los inmuebles publicados por propietarios e inmobiliarias aliadas. Todos pueden arrendarse con el respaldo de Cofianza.
            </p>
          </div>
          <Suspense fallback={
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
              ¿Listo para arrendar sin codeudor?
            </h2>
            <p className="text-gray-400 mb-8">
              Crea tu cuenta en Cofianza y empieza el proceso. Si eres propietario o inmobiliaria y quieres ofrecer arriendo con fianza, también puedes registrarte.
            </p>
