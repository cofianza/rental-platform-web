    ...
    <div className="min-h-screen grid lg:grid-cols-2 font-[family-name:var(--font-outfit)]">
      ...
      <div className="hidden lg:flex relative overflow-hidden bg-[#0F172A] text-white p-12 flex-col">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center mt-12">
          ...
          >
            <strong className="text-orange-500 font-normal">Soy yo.</strong> Llámanos.
          </p>
          ...
          <ul className="list-none space-y-0">
            {BENEFITS.map((b, i) => (
              ...
              >
                <div className="w-8 h-8 rounded-lg bg-emerald-500/[0.12] flex items-center justify-center shrink-0 text-emerald-400">
      ...
      <div className="bg-white flex flex-col px-6 py-10 lg:p-12">
        ...
        <div className="lg:hidden mb-8 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 text-gray-600 hover:text-emerald-700 transition-colors">
