...
export function PlantillaPreviewModal({
  ...
  return (
    <Modal isOpen onClose={onClose} bare ariaLabel="Vista previa de la plantilla" className="rounded-xl w-full max-w-4xl max-h-[90vh] overflow-hidden mx-4 flex flex-col">
      {/* Header */}
