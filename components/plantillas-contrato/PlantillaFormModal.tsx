...
export function PlantillaFormModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} bare ariaLabel="Plantilla de contrato" closeOnBackdrop={false} className="rounded-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto mx-4">
      {/* Header */}
