      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className={cn(
              'inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-primary-700 rounded-lg hover:bg-primary-800 transition-colors disabled:opacity-50',
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row sm:items-stretch gap-2 sm:gap-0">
          ...
          <button
            ...
            className="rounded-lg sm:rounded-l-none px-6 py-3 bg-primary-700 text-white text-sm font-semibold hover:bg-primary-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center justify-center gap-2"
          >
