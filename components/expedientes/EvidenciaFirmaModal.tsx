...
export function EvidenciaFirmaModal({ isOpen, onClose, solicitudId, nombreFirmante }: EvidenciaFirmaModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} bare ariaLabel="Evidencia de la firma" closeOnBackdrop={false} className="rounded-xl max-w-lg w-full mx-4 max-h-[90vh] overflow-y-auto">
      {/* Header */}
