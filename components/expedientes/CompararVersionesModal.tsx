...
export function CompararVersionesModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} bare ariaLabel="Comparar versiones del contrato" encima className="rounded-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto mx-4">
      {/* Header */}
