...
import { ESTADOS_CONTRATO, etiquetaContrato } from '@/lib/constants'
...
// Los contratos del asistente V3 nombran algunos estados distinto ("En firma", "Fianza activa"):
// el filtro muestra los dos nombres para que el gestor encuentre lo que ve en las listas.
const ESTADO_OPTIONS = Object.entries(ESTADOS_CONTRATO).map(([key, config]) => {
  const v3 = etiquetaContrato(key, true)
  return { value: key, label: v3 === config.label ? config.label : `${config.label} / ${v3}` }
})
    ...
    <div className="flex flex-col lg:flex-row gap-4">
      ...
      <div className="relative flex-1 min-w-0">
        ...
        <input
          ...
          placeholder="Buscar por arrendatario, cédula, dirección, código o N° de contrato…"
